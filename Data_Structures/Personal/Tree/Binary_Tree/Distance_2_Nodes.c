...
int find_level (Tree* root, int key, int level)
{
	if (root == NULL)
		return -1;
...
int main()
{
	...
	else
	{
		...
		int distance = find_distance (lca, 4, 5);
		printf ("Distance between the Nodes %d and %d is: %d\n", 4, 5, distance);
	}
	...
	{
		printf ("Least Common Ancestor for the Nodes %d and %d is: %d\n", 4, 10, lca->data);
		int distance = find_distance (lca, 4, 10);
		printf ("Distance between the Nodes %d and %d is: %d\n", 4, 10, distance);
	}
	...
	{
		printf ("Least Common Ancestor for the Nodes %d and %d is: %d\n", 6, 7, lca->data);
		int distance = find_distance (lca, 6, 7);
		printf ("Distance between the Nodes %d and %d is: %d\n", 6, 7, distance);
	}
	...
	{
		printf ("Least Common Ancestor for the Nodes %d and %d is: %d\n", 4, 7, lca->data);
		int distance = find_distance (lca, 4, 7);
		printf ("Distance between the Nodes %d and %d is: %d\n", 4, 7, distance);
	}
	...
	{
		printf ("Least Common Ancestor for the Nodes %d and %d is: %d\n", 3, 7, lca->data);
		int distance = find_distance (lca, 3, 7);
		printf ("Distance between the Nodes %d and %d is: %d\n", 3, 7, distance);
	}
	...
	{
		printf ("Least Common Ancestor for the Nodes %d and %d is: %d\n", 2, 5, lca->data);
		int distance = find_distance (lca, 2, 5);
		printf ("Distance between the Nodes %d and %d is: %d\n", 2, 5, distance);
	}
	...
	{
		printf ("Least Common Ancestor for the Nodes %d and %d is: %d\n", 2, 6, lca->data);
		int distance = find_distance (lca, 2, 6);
		printf ("Distance between the Nodes %d and %d is: %d\n", 2, 6, distance);
	}
	return 0;
}
