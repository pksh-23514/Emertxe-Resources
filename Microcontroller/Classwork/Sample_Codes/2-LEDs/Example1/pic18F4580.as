...
l773:
;main.c: 12: unsigned long i;;main.c: 13: unsigned long j;;main.c: 15: init_config();
	call	_init_config	;wreg free
	line	20
	
l775:
;main.c: 18: {;main.c: 20: PORTB = 0xF0;
	movlw	low(0F0h)
...
;main.c: 21: for ( i = 50000; i--;);
	...
	movwf	((c:main@i+2))^00h,c
	movlw	high highword(0C350h)
	movwf	((c:main@i+3))^00h,c
	
l779:
	decf	((c:main@i))^00h,c
	movlw	0
	subwfb	((c:main@i+1))^00h,c
	subwfb	((c:main@i+2))^00h,c
	subwfb	((c:main@i+3))^00h,c
		incf	((c:main@i))^00h,c,w
	bnz	u11
	incf	((c:main@i+1))^00h,c,w
	bnz	u11
	incf	((c:main@i+2))^00h,c,w
	bnz	u11
	incf	((c:main@i+3))^00h,c,w
	btfss	status,2
	goto	u11
	goto	u10
...
l781:
;main.c: 22: PORTB = 0x0F;
	movlw	low(0Fh)
	movwf	((c:3969))^0f00h,c	;volatile
	line	23
;main.c: 23: for (i = 50000; i--; );
	movlw	low(0C350h)
	movwf	((c:main@i))^00h,c
	movlw	high(0C350h)
	movwf	((c:main@i+1))^00h,c
