...
l779:
;main.c: 18: unsigned short i;;main.c: 20: init_config();
	call	_init_config	;wreg free
	line	24
	
l781:
;main.c: 23: {;main.c: 24: PORTBbits.RB1 = 1;
	bsf	((c:3969))^0f00h,c,1	;volatile
	line	25
...
l19:
	line	27
;main.c: 27: PORTBbits.RB1 = 0;
	bcf	((c:3969))^0f00h,c,1	;volatile
	line	28
	
l787:
;main.c: 28: for (i = 50000; i--; );
	movlw	high(0C350h)
	movwf	((c:main@i+1))^00h,c
	movlw	low(0C350h)
	movwf	((c:main@i))^00h,c
...
l773:
;main.c: 7: ADCON1 = 0x0F;
	movlw	low(0Fh)
	movwf	((c:4033))^0f00h,c	;volatile
	line	9
	
l775:
;main.c: 9: PORTBbits.RB1 = 0;
	bcf	((c:3969))^0f00h,c,1	;volatile
	line	11
;main.c: 11: TRISB = 0;
	movlw	low(0)
